...
public interface TrimestreRepository extends CrudRepository<Trimestre, Long>{
	...
	public List<Trimestre> findByEtablissement (Etablissement etablissement) ;
	public List<Trimestre> findByEtablissementAndAnneeScolaire (Etablissement etablissement, AnneeScolaire anneeScolaire) ;
	public Trimestre findByEtablissementAndAnneeScolaireAndCourant (Etablissement etablissement, AnneeScolaire anneeScolaire, int courant) ;
}
