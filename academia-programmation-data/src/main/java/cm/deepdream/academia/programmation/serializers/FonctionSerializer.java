...
public class FonctionSerializer extends JsonSerializer<Fonction>{

	@Override
	public void serialize(Fonction value, JsonGenerator jsonGenerator, SerializerProvider serializers) throws IOException {
