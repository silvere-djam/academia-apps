...
public class GroupeSerializer extends JsonSerializer<Groupe>{

	@Override
	public void serialize(Groupe value, JsonGenerator jsonGenerator, SerializerProvider serializers) throws IOException {
