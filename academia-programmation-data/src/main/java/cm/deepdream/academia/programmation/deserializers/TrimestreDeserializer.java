...
public class TrimestreDeserializer extends JsonDeserializer<Trimestre>{
	private Logger logger = Logger.getLogger(TrimestreDeserializer.class.getName()) ;
	
	
	public TrimestreDeserializer() {
		super() ;
	}
	
	public Trimestre deserialize(JsonParser jp, DeserializationContext ctxt) throws IOException, JsonProcessingException {
        ...
        trimestre.setId(id);
        trimestre.setNum(num);
        trimestre.setCreateur(createur);
        trimestre.setModificateur(modificateur);
        trimestre.setDateCreation(dateCreation);
        trimestre.setDateDernMaj(dateDernMaj);
        trimestre.setLibelle(libelle);
        trimestre.setDateDebut(dateDebut);
        trimestre.setDateFin(dateFin);
        trimestre.setNumero(numero);
        trimestre.setCourant(courant);
