...
public class TrimestreSerializer extends JsonSerializer<Trimestre>{

	@Override
	public void serialize(Trimestre value, JsonGenerator jsonGenerator, SerializerProvider serializers) throws IOException {
