...
public class TypeExamenSerializer extends JsonSerializer<TypeExamen>{

	@Override
	public void serialize(TypeExamen value, JsonGenerator jsonGenerator, SerializerProvider serializers) throws IOException {
		...
		if(value != null) {
        	...
        	jsonGenerator.writeStringField("periodicite", value.getPeriodicite());
