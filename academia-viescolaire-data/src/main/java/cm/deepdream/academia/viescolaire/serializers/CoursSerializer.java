...
public class CoursSerializer extends JsonSerializer<Cours>{
	...
	@Override
	public void serialize(Cours value, JsonGenerator jsonGenerator, SerializerProvider serializers) throws IOException {
		...
		if(value != null) {
        	...
        	jsonGenerator.writeNumberField("presents", value.getPresents() == null ? 0L:value.getPresents());
        	jsonGenerator.writeNumberField("absents", value.getAbsents() == null ? 0L:value.getAbsents());
        	jsonGenerator.writeStringField("statut", value.getStatut());
        	jsonGenerator.writeStringField("type", value.getType());
        	jsonGenerator.writeStringField("typeCours", value.getTypeCours());
